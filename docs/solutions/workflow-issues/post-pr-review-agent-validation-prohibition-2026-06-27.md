...
- Do NOT run pnpm build, pnpm test, pnpm lint, pnpm typecheck, pnpm depcruise, or pnpm test:bash
...
Your ONLY responsibility is: read the comment, make a code change (if needed), commit, and push.
Write result.json and stop immediately. Complete your work in under 60 seconds.
```
