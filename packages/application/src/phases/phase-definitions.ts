...
export const STANDARD_LEAN_PHASE_ORDER: readonly PhaseName[] = [
  ...
  makePhaseName('validate'),
  makePhaseName('fix-validate'),
  makePhaseName('spec-review'),
  makePhaseName('quality-review'),
...
const _phaseDefinitions = {
  ...
  'spec-review': {
    name: makePhaseName('spec-review'),
    inputs: {
      required: ['issue.md', 'design.md'],
      optional: ['issue-comments.md', 'plan.md', 'validation.result'],
    },
    outputs: [
      'spec-review.md',
      'spec-review.json',
  ...
  'quality-review': {
    name: makePhaseName('quality-review'),
    inputs: {
      required: ['issue.md'],
      optional: [
        'design.md',
    ...
    outputs: ['quality-review.md', 'quality-review.json', 'code-review.md', 'finding-ledger.json'],
    retrySafety: 'safe',
    skippable: false,
  },
  'fix-review': {
    ...
    inputs: {
      ...
      optional: ['spec-review.json', 'quality-review.json', 'finding-ledger.json'],
    },
    outputs: [],
    retrySafety: 'unsafe',
    skippable: false,
