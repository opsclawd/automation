...
const _phaseDefinitions = {
  ...
  'plan-design': {
    ...
    outputs: ['design.md'],
    agentContract: { requiredArtifacts: ['design.md', 'result.json'], mustNotChangeBranch: true },
    retrySafety: 'safe',
    skippable: false,
  },
  'plan-write': {
    ...
    outputs: ['plan.md'],
    agentContract: { requiredArtifacts: ['plan.md', 'result.json'], mustNotChangeBranch: true },
    retrySafety: 'safe',
    skippable: false,
  },
  implement: {
