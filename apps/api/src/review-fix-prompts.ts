...
export function buildReviewFixFixPrompt(input: BuildFixPromptInput): string {
  ...
  sections.push(
    ...
    '- Do NOT ask questions.',
    '- Do NOT switch branches. All work must stay on the current branch.',
    '- After fixing, you SHOULD commit your change before writing result.json:',
    '  If git commit fails (e.g. hook failure), you may leave the worktree dirty',
    '  and report result="done_with_fixes". The orchestrator will attempt to',
    '  commit for you after validation.',
    '',
    '  If you DO commit:',
