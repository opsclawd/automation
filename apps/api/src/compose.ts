...
export function buildImplementPrompt(
  ...
  return [
    ...
    '',
    `MANDATORY REPORTING: You MUST write implementation-log.md before reporting`,
    `DONE, even if you determine that Task ${taskN} is already complete and no`,
    ...
    `2. If you determine Task ${taskN} is already implemented and committed in`,
    '   the current branch, verify its completeness and integrity via git.',
    `3. Implement exactly what Task ${taskN} specifies — nothing more.`,
    `4. Write tests following TDD where applicable, scoped to Task ${taskN}.`,
    `5. Verify Task ${taskN}'s implementation works.`,
    '6. Commit your work (if any changes were made):',
    ...
    '7. MANDATORY: Write a summary of your work to implementation-log.md.',
    '   You MUST do this even if no new changes were made.',
    `8. Self-review before reporting back, including the scope check below.`,
    '',
    '## Questions?',
    ...
    '  git status --porcelain empty? (See step 6c/d.)',
    '- Reporting: Did I write implementation-log.md? (This is MANDATORY)',
