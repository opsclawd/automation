          ...
          },
          {
            ...
            iterations: [
              ...
              },
              {
                ...
                fixInvocationId: 'fb2',
                revalidationId: 'rv2',
                reviewArtifactPath: 'review-fix/review/iter-2/code-review.md',
                fixArtifactPath: 'review-fix/fix/iter-2/result.json',
                revalidateArtifactPath: 'revalidate/iter-2/validation-result.json',
